 ...
 * Page alter.
 */
function tpl_cricket_page_alter($page) {
 ...
 */
function tpl_cricket_preprocess_html(&$variables) {
	/**
	 * Add IE8 Support
	 */
	...
	*/
	if (theme_get_setting('bootstrap_js_include', 'tpl_cricket')) {
	drupal_add_js(drupal_get_path('theme', 'tpl_cricket') . '/bootstrap/js/bootstrap.min.js');
	}
	//EOF:Javascript
	...
	*/
	if (theme_get_setting('scrolltop_display', 'tpl_cricket')) {
 ...
 */
function tpl_cricket_process_html(&$vars) {
 ...
 */
function tpl_cricket_preprocess_page(&$vars) {
 ...
 */
function tpl_cricket_process_page(&$variables) {
  // Hook into color.module.
  if (module_exists('color')) {
 ...
 */
function tpl_cricket_preprocess_block(&$variables) {
 ...
 */
function tpl_cricket_breadcrumb($variables) {
 ...
 */
function tpl_cricket_form_alter(&$form, &$form_state, $form_id) {
